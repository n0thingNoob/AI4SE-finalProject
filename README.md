...
```
AI4SE-finalProject/
├── strategy/                          # Generated trading strategies
│   ├── gemini/                        # Gemini-generated strategies
│   │   ├── analysis_json_output/      # Market analysis JSON files
│   │   │   ├── gemini_nvda.json
│   │   │   ├── gemini_tqqq.json
│   │   │   └── gemini_tsla.json
│   │   └── generated_trading_code/    # Python strategy implementations
│   │       ├── gemini_nvda.py
│   │       ├── gemini_tqqq.py
│   │       └── gemini_tsla.py
│   └── gpt/                           # GPT-generated strategies
│       ├── analysis_json_output/      # Market analysis JSON files
│       │   ├── chatgpt_nvda.json
│       │   ├── chatgpt_tqqq.json
│       │   └── chatgpt_tsla.json
...
│           ├── chatgpt_tqqq.py
│           └── chatgpt_tsla.py
├── prompt/                            # LLM prompts for strategy generation
│   ├── analysis_prompt.md             # Prompt for market analysis (JSON output)
│   └── code_generate_prompt.md        # Prompt for code generation (Python output)
├── tests/                             # Testing framework
│   ├── framework_stub.py              # Mock framework APIs for testing
│   ├── strategy_loader.py             # Auto-discover and load strategies
│   ├── test_data_generator.py         # Generate test data (boundary/random)
│   ├── robustness_tests.py            # Robustness testing module
│   ├── code_quality_scorer.py         # Code quality scoring system
│   ├── test_generated_strategy.py     # Main test runner
│   ├── run_tests.sh                   # Linux/Mac test script
│   ├── run_tests.bat                  # Windows test script
│   └── README.md                      # Testing framework documentation
├── pyproject.toml                     # Ruff/Pylint configuration
...
- Total scores with proper maximum values (100 × file count)
...
- Total scores (sum of all strategies, max = 100 × file count)
